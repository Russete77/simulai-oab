...
export const metadata: Metadata = {
  ...
  description: 'Conheça o Simulai OAB: plataforma de simulados para o Exame da OAB com 3.607 questões oficiais FGV, explicações por IA, gamificação e predição de aprovação. Saiba como funciona.',
  keywords: [
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="space-y-12 mb-16">
            {[
              ...
              { step: 3, title: 'Resolva questões oficiais FGV', desc: '3.607 questões reais de 2010 a 2026, com cronômetro e navegação idênticos à prova real. Nada de questões inventadas.', icon: BookOpen },
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                { icon: Star, title: 'Questões Oficiais', desc: '3.607 questões FGV de 2010 a 2026, atualizadas a cada exame' },
              ].map((feature, i) => (
