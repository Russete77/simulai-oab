        ...
        <section>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <h1>3.607 questões. Uma plataforma.</h1>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="max-w-2xl text-ink-1">
                Plataforma com 3.607 questões oficiais da OAB, simulados adaptativos,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl">
            <Card>
              ...
              <ul className="space-y-2 mb-8 text-sm text-ink-2">
                {['3.607 questões oficiais', 'Simulados ilimitados', 'Analytics avançado', 'Flashcards e revisão'].map(
                  (i) => (
        ...
        <section>
          ...
          <Card padding="none">
            <ul>
              {[
                {
                  title: '3.607 questões disponíveis',
