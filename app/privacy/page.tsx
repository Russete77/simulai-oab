  ...
  return (
    <div className="min-h-screen bg-bg py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-accent hover:text-accent mb-8 transition-colors"
        >
        ...
        <Card variant="glass" className="p-8 md:p-12">
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-ink-1 mb-2">📜 Política de Privacidade</h1>
            <p className="text-ink-2">Última atualização: 16 de outubro de 2025</p>
          </div>
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              <p className="text-ink-1/90 leading-relaxed">
                ...
                <a href="https://www.simulaioab.com" className="text-accent hover:text-accent">
                  www.simulaioab.com
                </a>
                .
              </p>
              <p className="text-ink-1/90 leading-relaxed mt-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink-1 mb-4">1. Informações que Coletamos</h2>

              <h3 className="text-xl font-semibold text-ink-1/90 mb-3 mt-6">1.1. Informações pessoais fornecidas pelo usuário</h3>
              <ul className="list-disc list-inside text-ink-1/80 space-y-2 ml-4">
                <li>Nome completo</li>
                <li>E-mail</li>
              ...
              <h3 className="text-xl font-semibold text-ink-1/90 mb-3 mt-6">1.2. Informações de uso</h3>
              <ul className="list-disc list-inside text-ink-1/80 space-y-2 ml-4">
              ...
              <h3 className="text-xl font-semibold text-ink-1/90 mb-3 mt-6">1.3. Cookies / tecnologias semelhantes (para versão web)</h3>
              <ul className="list-disc list-inside text-ink-1/80 space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink-1 mb-4">2. Finalidade do Uso dos Dados</h2>
              <p className="text-ink-1/90 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink-1 mb-4">3. Armazenamento e Segurança dos Dados</h2>
              <ul className="list-disc list-inside text-ink-1/80 space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink-1 mb-4">4. Compartilhamento de Dados</h2>
              <p className="text-ink-1/90 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink-1 mb-4">5. Retenção e Exclusão de Dados</h2>
              <ul className="list-disc list-inside text-ink-1/80 space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink-1 mb-4">6. Direitos do Usuário (LGPD)</h2>
              <p className="text-ink-1/90 leading-relaxed mb-4">
                Você tem direito de:
              </p>
              <ul className="list-disc list-inside text-ink-1/80 space-y-2 ml-4">
              ...
              <p className="text-ink-1/90 leading-relaxed mt-4">
                ...
                <a href="mailto:privacidade@simulaioab.com" className="text-accent hover:text-accent">
            ...
            {/* 7. Menores de Idade */}
            <section>
              <h2 className="text-2xl font-semibold text-ink-1 mb-4">7. Uso por Menores de Idade</h2>
              <p className="text-ink-1/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink-1 mb-4">8. Transferência Internacional de Dados</h2>
              <p className="text-ink-1/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink-1 mb-4">9. Alterações na Política</h2>
              <p className="text-ink-1/90 leading-relaxed">
            ...
            {/* 10. Contato */}
            <section className="bg-surface-2 rounded-lg p-6 border">
              <h2 className="text-2xl font-semibold text-ink-1 mb-4">10. Contato</h2>
              <p className="text-ink-1/90 leading-relaxed mb-4">
                Para dúvidas ou solicitações relativas à privacidade:
              </p>
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-ink-1/80">
