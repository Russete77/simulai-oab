  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">Blog Simulai OAB</h1>
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg font-medium transition-all ${
              selectedCategory === category
                ...
                : 'bg-navy-900/50 text-navy-300 hover:bg-navy-900 hover:text-white border border-navy-800'
            }`}
          >
            {category}
          </button>
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {post.tags.slice(0, 2).map((tag) => (
                  <span key={tag} className="text-xs text-navy-400 bg-navy-800/50 px-2 py-1 rounded">
                    {tag}
                  </span>
                ))}
              </div>
              ...
              {/* Read More Button */}
              <div className="mt-auto flex items-center gap-2 text-blue-400 font-medium hover:text-blue-300 transition-colors">
      ...
      {filteredPosts.length === 0 && (
        <Card variant="glass" className="border-2 border-blue-500/30 text-center py-12">
          <Newspaper className="w-16 h-16 text-navy-400 mx-auto mb-4 opacity-50" />
          <p className="text-navy-300 text-lg">Nenhum artigo nesta categoria</p>
        </Card>
      )}

      {/* CTA Section */}
      <div className="mt-16 bg-gradient-to-r from-blue-600/10 to-purple-600/10 border border-blue-500/20 rounded-2xl p-8 sm:p-12">
